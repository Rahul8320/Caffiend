...
export type IStatusLevel = {
  low: IStatusDetails;
  moderate: IStatusDetails;
  high: IStatusDetails;
};
...
export type ICoffeeConsumptionHistory = {
  [key: string]: ICoffee;
};
...
export const statusLevels: IStatusLevel = {
  low: {
    color: "#047857",
    background: "#d1fae5",
    description:
...
export const coffeeConsumptionHistory: ICoffeeConsumptionHistory = {
...
export const coffeeOptions: ICoffeeOption[] = [
...
export function getTopThreeCoffees(historyData: ICoffeeConsumptionHistory) {
...
export function calculateCoffeeStats(
  coffeeConsumptionHistory: ICoffeeConsumptionHistory
) {
  const dailyStats: { [date: string]: IDailyStat } = {};
  let totalCoffees = 0;
  let totalCost = 0;
  let totalCaffeine = 0;
